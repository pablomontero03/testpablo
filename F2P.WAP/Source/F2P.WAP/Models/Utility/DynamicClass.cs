...
namespace F2P.WAP.Models.Utility
{
    public class DynamicClass
    {
        ...
        /// <summary>
        /// ivan cortes crea el objeto
        /// </summary>
        /// <param name="PropertyNames">arreglo de nombres del objeto</param>
        /// <param name="Types">typos de datos del objeto</param>
        /// <returns></returns>
        public object CreateObject(string[] PropertyNames, Type[] Types)
        {
            if (PropertyNames.Length != Types.Length)
            {
                throw new Exception("El número de nombres de propiedades debe coincidir con el número de tipos correspondientes");
            }
        ...
        /// <summary>
        /// ivan cortes crea clase en runtime
        /// </summary>
        /// <returns></returns>
        private TypeBuilder CreateClass()
        {
            ...
            TypeBuilder typeBuilder = moduleBuilder.DefineType(this.asemblyName.FullName
                                ...
                                , null);
            //assemblyBuilder.Save(asemblyName.Name + ".dll");
            return typeBuilder;
        }
        /// <summary>
        /// ivan cortes crea el constructor
        /// </summary>
        ...
        /// <summary>
        ///ivan cortes crea las propiedades de la clase
        /// </summary>
        /// <param name="typeBuilder"></param>
